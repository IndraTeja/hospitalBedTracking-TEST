...
class Contact_us(unittest.TestCase):
   ...
   def test_contact_us(self):
       ...
       elem = driver.find_element_by_xpath("/html/body/nav/div/div[2]/ul[1]/li[3]/a")
       elem.click()
       time.sleep(2)
      ...
      # To contact hospital by Posting information
       ...
       time.sleep(1)
       elem = driver.find_element_by_id("id_emailId")
       elem.send_keys("djantz@unomaha.edu")
       time.sleep(1)
       elem = driver.find_element_by_id("id_question")
       ...
       elem = driver.find_element_by_xpath("/html/body/div/div/div/div/div[2]/div/div/div/div[2]/form/button")
       elem.click()
       time.sleep(2)
